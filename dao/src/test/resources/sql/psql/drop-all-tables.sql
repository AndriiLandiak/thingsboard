...
DROP TABLE IF EXISTS calculated_field;
DROP TABLE IF EXISTS cf_debug_event;
DROP TABLE IF EXISTS device_profile_firmware;
DROP TABLE IF EXISTS domain_oauth2_client;
DROP TABLE IF EXISTS domain;
DROP TABLE IF EXISTS job;
DROP TABLE IF EXISTS key_dictionary;
DROP TABLE IF EXISTS mobile_app_bundle_oauth2_client;
DROP TABLE IF EXISTS mobile_app_bundle;
